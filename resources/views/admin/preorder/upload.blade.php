          ...
          <table class="table">
            ...
            <tbody>
              <tr>
                ...
                <td>
                    <form action="">
                        <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="harga">
                    </form>
                </td>
                <td>
                    <form action="">
                        <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="kuantitas">
                    </form>
                </td>
              </tr>
            </tbody>
