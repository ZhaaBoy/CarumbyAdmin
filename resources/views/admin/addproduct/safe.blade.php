                    ...
                    <form action="product.store" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="card" style="background-color: white; width: 150px; height: 150px:">
                                <label for="formFileSm"><img src="/assets/uploadd.png" alt=""
                                        style="cursor: pointer" width="150px" height="150px"></label>
                                <input class="form-control form-control-sm" id="formFileSm" style="display: none"
                ...
                <div class="card-body">
                    ...
                    <form action="">
                        ...
                        <div class="card p-3 row mb-3">
                            ...
                            <div class="d-flex  ">
                                @forelse ($color as $cr)
                                    <div class="btn-group g-3" role="group"
                                        aria-label="Basic checkbox toggle button group">
                                        <input type="checkbox" class="btn-check" id="{{ $cr->name }}" name="colors[]" value="{{$cr->name}}"
                                            autocomplete="off">
                ...
                <div class="d-flex grid">
                    @forelse ($size as $sz)
                        <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                            <input type="checkbox" class="btn-check" id="{{ $sz->name }}" name="sizes[]" value="{{ $sz->name }}
                                autocomplete="on">
