            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <div class="card" style="background-color: white; width: 150px; height: 150px:">
                        <label for="productimage"><img src="/assets/uploadd.png" alt=""
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="card" style="background-color: white; width: 150px; height: 150px:">
                        <label for="format_size"><img src="/assets/uploadd.png" alt=""
                            style="cursor: pointer" width="150px" height="150px"></label>
                ...
                <div class="mb-3">
                    ...
                    <div class="card" style="background-color: white; width: 150px; height: 150px:">
                        <label for="video"><img src="/assets/uploadd.png" alt=""
                            style="cursor: pointer" width="150px" height="150px"></label>
                        <input class="form-control form-control-sm" id="video" style="display: none"
                            name="video[]" type="file" multiple>
                    </div>
                </div>
