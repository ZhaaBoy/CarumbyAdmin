...
@section('content')
    <form action="{{ route('product.store') }}" method="POS">
        @csrf
        {{-- product name, gambar --}}
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="card" style="background-color: white; width: 150px; height: 150px:">
                            <label for="formFileSm1"><img src="/assets/uploadd.png" alt="" style="cursor: pointer"
                                    width="150px" height="150px"></label>
                            <input class="form-control form-control-sm" id="formFileSm1" style="display: none" name="image"
                                type="file">
                        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="card" style="background-color: white; width: 150px; height: 150px:">
                        <label for="formFileSm2"><img src="/assets/uploadd.png" alt="" style="cursor: pointer"
                                width="150px" height="150px"></label>
                        <input class="form-control form-control-sm" id="formFileSm2" style="display: none" name="format_size"
                            type="file">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="card" style="background-color: white; width: 150px; height: 150px:">
                        <label for="formFileSm3"><img src="/assets/uploadd.png" alt="" style="cursor: pointer"
                                width="150px" height="150px"></label>
                        <input class="form-control form-control-sm" id="formFileSm3" style="display: none" name="video"
                            type="file">
                    </div>
                </div>
    ...
    <div class="card row mt-3 grid-margin">
                ...
                <div class="row g-3">
                    <div class="col-4">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" name="height" aria-label="Recipient's username"
                                aria-describedby="basic-addon2">
                    ...
                    <div class="col-3">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" name="width" aria-label="Recipient's username"
                                aria-describedby="basic-addon2">
                            <span class="input-group-text" id="basic-addon2">cm</span>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" name="lenght" aria-label="Recipient's username"
                                aria-describedby="basic-addon2">
                            <span class="input-group-text" id="basic-addon2">cm</span>
                        </div>
                    </div>
